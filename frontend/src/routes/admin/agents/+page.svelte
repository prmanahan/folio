    ...
    <div style="background: var(--nb-bg2); border: 1px solid var(--nb-border); border-radius: 0.625rem; padding: 1.25rem; margin-bottom: 1rem;" oninput={() => isDirty = true}>
      <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 0.875rem;">
        ...
        <div>
          ...
          <select id="field-model" class="nb-input" bind:value={form.model} onchange={() => isDirty = true}>
        ...
        <div style="grid-column: 1 / -1; display: flex; flex-direction: column; gap: 0.5rem;">
          <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
            <input type="checkbox" bind:checked={form.is_featured} onchange={() => isDirty = true} />
            <span class="nb-label" style="margin-bottom: 0;">Featured (shows as hero band)</span>
          </label>
          <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
            <input type="checkbox" bind:checked={form.is_review_gate} onchange={() => isDirty = true} />
            <span class="nb-label" style="margin-bottom: 0;">Review Gate</span>
          </label>
          <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
            <input type="checkbox" bind:checked={form.published} onchange={() => isDirty = true} />
